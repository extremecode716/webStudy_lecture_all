...
<table border=1 width=450 align="center">
	...
	<tr><td>전화번호</td>
		<td><input type=text size=4 maxlength=4 id="tel1" name="tel1" value="${member.tel1 }">-
		    <input type=text size=4 maxlength=4 id="tel2" name="tel2" value="${member.tel2 }">-
		    <input type=text size=4 maxlength=4 id="tel3" name="tel3" value="${member.tel3 }">-
		</td>
	</tr>
	<tr><td>핸드폰</td>
		<td><select id="phone1" name="phone1">
			...
			<input type=text size=4 maxlength=4 id="phone2" name="phone2" value="${member.phone2 }">-
		    <input type=text size=4 maxlength=4 id="phone3" name="phone3"  value="${member.phone3 }">		
		</td>	
	</tr>
	<tr><td>우편번호</td>
		<td><input type=text size=5 maxlength=5 id="post" name="post" value="${member.post }">

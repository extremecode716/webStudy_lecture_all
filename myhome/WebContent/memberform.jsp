	...
	<form method="post" action="member.jsp">
		<table border=1 width=600 align=center>
			...
			<tr>
				<th>E-Mail</th>
				<td>
					<input type=text size=10 name="mailid">
					@
			...
			<tr>
				<th>주소</th>
				<td>
					<input type=text size=70 id="address">
				</td>
			</tr>
			<tr>
				<th>성별</th>
			...
			<tr>
				<th>취미</th>
				<td>
					<input type="checkbox" name="hobby" value="공부" checked>
					공부
					<input type="checkbox" name="hobby" value="게임" checked="checked">
					게임
			...
			<tr>
				<th>자기소개</th>
				<td>
					<textarea rows="5" cols="70" placeholder="자기소개를 100자 이내로 입력하세요."></textarea>
				</td>
			</tr>
			<tr>
